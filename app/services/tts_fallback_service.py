    ...
    def _gtts_generate(self, text: str, language: str = "en") -> bytes:
        try:
            ...
            if language not in lang_map:
                # Don't silently fall back to English audio; enforce user-preferred language.
                raise ValueError(f"gTTS language not supported for '{language}'")
            gtts_lang = lang_map[language]
